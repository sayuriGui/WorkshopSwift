...
extension Project {
    static let myProjects = [
        ...
        Project(title: "CertfAI Dashboard IBM", description: "Enabled data-driven decision-making for employee training by granting access to data from 16 million certifications and skills, enabling informed decisions about their company.", rating: 5, photos: []),
